...
function CheckboxPage() {
  ...
  const handleContinue = () => {
    if (isAnyCheckboxSelected()) {
      axios
        .post('http://45.55.45.170:8081/step2_video', { step3 })
        .catch((error) => {
          console.error('API error:', error);
        });
    } else {
      window.location.href = '/video-services'; // Navigate to '/step4' if no selection is made
    }
    // Custom logic to route based on step3
if (step3.logo) {
  window.location.href = '/video-services'; // Navigate to the logo page
} else if (step3.agriculture) {
  window.location.href = '/video-services'; // Navigate to the web page
} else if (step3.art) {
  window.location.href = '/video-services'; // Navigate to the video page
} else if (step3.construction) {
  window.location.href = '/video-services'; // Navigate to the mobile page
  ...
  window.location.href = '/video-services'; // Navigate to a default page
}
