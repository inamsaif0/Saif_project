...
function CheckboxPage() {
  ...
  const handleContinue = () => {
    if (isAnyCheckboxSelected()) {
      axios
        .post('http://45.55.45.170:8081/step2_logo', { step3 })
        .catch((error) => {
          console.error('API error:', error);
        });
    } else {
      window.location.href = '/color-picker'; // Navigate to '/step4' if no selection is made
    }
    // Custom logic to route based on step3
if (step3.logo) {
  window.location.href = '/color-picker'; // Navigate to the logo page
} else if (step3.agriculture) {
  window.location.href = '/color-picker'; // Navigate to the web page
} else if (step3.art) {
  window.location.href = '/color-picker'; // Navigate to the video page
} else if (step3.construction) {
  window.location.href = '/color-picker'; // Navigate to the mobile page
  ...
  window.location.href = '/color-picker'; // Navigate to a default page
}
