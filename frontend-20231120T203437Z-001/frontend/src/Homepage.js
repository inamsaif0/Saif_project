...
export default class Homepage extends Component {
  render() {
    return (     
      <div>
        <Navigationbar />
        <div style={{textAlign:'center', backgroundColor:'#1c1c1b'}}>
            <br></br>
            <br></br>
            <br></br>
            <br></br>
            ...
            <br></br>
            <br></br>
            <h1 style={{ fontSize:'4.2rem',color:'white'}}>Looking for a Custom Logo Design?</h1>  
            <p style={{margin:'0 5rem', fontSize:'20px', color:'white'}}>We can create a professional, digitized, custom logo based on your instructions. Whether you have a very specific vision, sketch or are open to our input, we got you covered. Try our professional logo design services today.
            </p>
            <br></br>  
        </div>
        <div style={{textAlign:'center'}}>
        <h1 style={{marginTop:'3rem'}}>Play the Video to See How It Works</h1> 
        <div >
        <iframe style={{marginTop:'3rem', width:'85%', height:'30rem'}} src="https://www.youtube.com/embed/tgbNymZ7vqY">
        </iframe>
        </div>
        <div>
        <h1 style={{marginTop:'3rem'}}>Our Custom Logo Packages</h1>
        <p>To get started choose a plan and then tell us your logo vision during the next step.</p>
        </div>
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-text">Ready in 3 days</p>
            <hr></hr>
            <ul style={{listStyleType:'none', textAlign:'initial', marginTop:'2rem'}}>
                <li>&#10003; 1 original logo concept</li>
                <li>&#10003; Unlimited revisions</li>
                <li>&#10003; High-resolution</li>
                <li>&#10003; Transparent background</li>
                <li>&#10003; Vector (source) files</li>
                <li>&#10003; JPG, PNG, PDF, AI, EPS</li>
                <li>&#10539; Animated logo (video+GIF)</li>
                <li>&#10539; Social media kit</li>
                <li>&#10539; Stationery design</li>
                <li>&#10539; VIP support</li>
            </ul>
            <br></br>
            <a href="#" class="pkg-btn" style={{border:'1.5px solid', borderRadius:'7px'}}>Get Started</a>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card"  style={{backgroundColor:'#36F',color:'white'}}>
          <div class="card-body">
            <h5 class="card-title">Standard</h5>
            <p class="card-text">Ready in 2 days</p>
            <hr></hr>
            <ul style={{listStyleType:'none',textAlign:'initial', marginTop:'2rem'}}>
                <li>&#10003; 1 original logo concept</li>
                <li>&#10003; Unlimited revisions</li>
            ...
            <br></br>
            <a href="#" class="pkg2-btn" style={{backgroundColor:'#0d6dfda8',color:'white',border:'1.5px solid', borderRadius:'7px'}}>Get Started</a>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-text">Ready in 1 day</p>
            <hr></hr>
            <ul style={{listStyleType:'none', textAlign:'initial', marginTop:'2rem'}}>
                <li>&#10003; 1 original logo concept</li>
                <li>&#10003; Unlimited revisions</li>
        ...
        <div style={{textAlign:'center'}}>
        <h1 style={{marginTop:'10rem'}}>Have Questions About Our Custom Logo Design Service?</h1>
        <p>If you can't find your answer below please <a href='#'>contact us.</a></p>
        <br></br>
         </div>   
      ...
      <Accordion >
        <AccordionSummary
          ...
          id="panel1a-header"
        >
          <h5>What if I don’t like my custom logo?</h5>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
          We’ll work with you until you do. Once you receive your initial concept you can reply to the designer directly and share your feedback. The designer will then incorporate your changes and send you the revised concept. You get unlimited rounds of revisions.
          </Typography>
        </AccordionDetails>
      </Accordion>
      <Accordion>
        <AccordionSummary
          ...
          id="panel2a-header"
        >
          <h5>Can I see my logo before I pay?</h5>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
          Since this is a custom design project the payment is upfront. This is standard industry practice, whether you get a freelance logo design or hire an agency.

Our team of graphic designers specializes in logo design and is very capable of executing any logo vision. We’ll work with you until you’re 100% satisfied. As soon as you complete the payment our design team will get started. We are excited to take on your project!
          </Typography>
        </AccordionDetails>
      </Accordion>
      <Accordion>
        <AccordionSummary
          ...
          id="panel2a-header"
        >
          <h5>When will I get my logo?</h5>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
          Your custom logo project will be assigned to one of our talented designers as soon as you complete your order. We’ll create a logo based on your instructions and it will be ready in as little as 1 day, depending on the logo package you choose.
          </Typography>
        </AccordionDetails>
      </Accordion>
      <Accordion>
        <AccordionSummary
          ...
          id="panel2a-header"
        >
          <h5>Where can I use my logo?</h5>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
          We’ll provide you high resolution files that you can use anywhere at any size, without losing quality. You’ll be able to show off your new logo on your website, social media, business cards, merchandise, clothing, store signs, banners, car decals, and anywhere else you can think of.
          </Typography>
        </AccordionDetails>
      </Accordion>
      <Accordion>
        ...
        <AccordionDetails>
          <Typography>
            ...
            Fill out the design brief (tell us exactly what you want)
            Complete your payment
            Receive your inital logo concept in your inbox in as little as 24 hours
            Reply to the designer to request revisions (if needed)
            Download your finalized logo and use it anywhere you want
          </Typography>
        </AccordionDetails>
      </Accordion>
      <Accordion>
        <AccordionSummary
          ...
          id="panel2a-header"
        >
          <h5>Do I own the rights?</h5>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
          Yes, we’ll transfer all design rights over to you. Whether it’s for a custom business logo or design for a personal project, you’ll own the commercial rights.
          </Typography>
        </AccordionDetails>
      </Accordion>
      </div> 
        ...
        <div style={{textAlign:'center'}}>
            <p style={{marginTop:'10rem'}}><b>TESTIMONIALS</b></p>
            <h1>Raving Reviews: See What Our Customers Say!</h1>
            <br></br>
            <p style={{margin:'0 5rem', fontSize:'20px'}}>Seo InsighterX has been offering professional logo design services for over 10 years. We have worked with thousands of happy customers across every possible industry, catering to all design preferences. Whether you are looking for modern, 3D, signature, cartoon, sketch to logo, we got you covered. Here are some recent TrustPilot verified reviews.</p>
        </div>
        <div>
...
<h5 class="widget-title">Seo InsighterX<span></span></h5>
...
<p><a href="mailto:info@seoinsighterx.com" title="glorythemes">info@seoinsighterx.com</a></p>
...
<p>Copyright Seo InsighterX © 2023. All rights reserved.</p>
</div>
</div>
</div>
</div>
